      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
            ...
            <div className="md:col-span-5 flex flex-col gap-6">
                ...
                <p className="text-white/60 text-sm font-sans leading-relaxed max-w-md border-l-2 border-orange-500/30 pl-4">
                  Empowering the next generation of developers to build the future of SaaS. 
                  <br/>
                  <span className="text-orange-500/80 font-mono text-xs mt-2 block">// SYSTEM.INITIATE_INNOVATION</span>
                </p>
            ...
            <div className="md:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-8">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <ul className="space-y-3 font-mono text-sm text-white/60">
                        {[
                            ...
                            <li key={i}>
                                <a href={link.href} className="hover:text-orange-500 transition-colors flex items-center gap-2 group">
                                    <span className="opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 transition-all text-orange-500">&gt;</span>
                                    {link.name}
                                </a>
                            </li>
                        ))}
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <ul className="space-y-3 font-mono text-sm text-white/60">
                        {["Code of Conduct", "Terms of Service", "Privacy Policy"].map((item, i) => (
                            <li key={i}>
                    ...
                    <div className="mt-2 text-xs font-mono text-white/40">
                        <div className="flex items-center gap-2 mb-1">
                         ...
                         <div className="flex items-center gap-2">
                            ...
                            Sphere Hive HQ, KVGCE, Kurunjibhag, Sullia, Dakshina Kannada, Karnataka - 574327
                        </div>
                    </div>
                </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
             ...
             <div className="text-xs text-white/40 font-mono uppercase tracking-wider">
                Designed by <span className="text-white hover:text-orange-500 cursor-pointer transition-colors">Sphere Hive</span>
             </div>
        </div>
