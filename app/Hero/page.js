          ...
          <div className="flex flex-col gap-8">
             <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-wrap gap-4">
                    ...
                    >
                        <div className="w-full h-full bg-[#0A090F] group-hover/btn:bg-orange-500/10 transition-colors duration-300 px-8 py-4 flex items-center gap-2 font-mono font-bold text-orange-500"
                           style={{
                                clipPath: "polygon(10px 0, 100% 0, 100% calc(100% - 10px), calc(100% - 10px) 100%, 0 100%, 0 10px)"
                            }}
                        >
                            <DecryptedText text="Join WhatsApp" sequential speed={40} />
