            ...
            <div className="flex flex-col gap-8 relative z-10 text-center md:text-left items-center md:items-start">
              <div className="space-y-4">
                <h2 className="font-hackwise text-4xl md:text-5xl lg:text-6xl text-white uppercase tracking-wide leading-tight">
                  ...
                  <span className="text-orange-500">Brochure</span>
                </h2>
                <p className="text-white/60 font-sans text-lg max-w-md leading-relaxed">
                  Access the complete guide to Hackwise 2.0. Explore the problem
                  statements, rules, judging criteria, and the complete
                  schedule.
                </p>
              </div>
              ...
              <a
                ...
                download
                className="w-fit px-8 py-4 text-black font-bold font-mono bg-orange-500  transition-all duration-300 rounded-none cursor-pointer shadow-[0_0_20px_rgba(249,115,22,0.4)] hover:shadow-[0_0_30px_rgba(249,115,22,0.6)] flex items-center gap-3 group/btn"
                style={{
                  clipPath:
