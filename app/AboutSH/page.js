          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
            <div className="space-y-4 text-center md:text-left">
              ...
              <p className="font-mono text-white/60 text-sm md:text-base max-w-xl">
                The next generation of innovation starts here. Secure your spot
                at Hackwise 2.0.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <a
                ...
                className="group/btn relative px-8 py-4 bg-orange-500 text-black font-mono font-bold text-lg transition-all duration-300 shadow-[0_0_20px_rgba(249,115,22,0.3)] hover:shadow-[0_0_35px_rgba(249,115,22,0.6)] flex items-center justify-center"
                style={{
                  clipPath:
              ...
              >
                <span className="flex items-center gap-2">
                  <DecryptedText text="REGISTER NOW" sequential speed={70} />
              ...
              >
                <div
                  className="w-full h-full bg-[#0A090F]  transition-colors duration-300 px-8 py-4 flex items-center justify-center"
                  style={{
                    clipPath:
                      "polygon(20px 0, 100% 0, 100% calc(100% - 20px), calc(100% - 20px) 100%, 0 100%, 0 20px)",
                  }}
                >
                  <span className="flex items-center gap-2">
                    <DecryptedText text="WHATSAPP" sequential speed={70} />
        ...
        <div className="lg:col-span-8 flex flex-col gap-8 order-1 lg:order-2">
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-4">
              <div className="w-3 h-3 bg-orange-500 shadow-[0_0_10px_rgba(255,122,26,0.5)] -mt-9"></div>
          ...
          <div className="bg-white/5 border border-white/10 p-6 md:p-10 backdrop-blur-sm relative group hover:border-orange-500/30 transition-colors duration-500">
            <p className="text-body font-sans text-sm md:text-base mb-8">
              Sphere Hive is the crucible of innovation. We don't just teach
              technology; we forge the leaders who will define it. By fusing
              bleeding-edge tech with radical creativity, we empower you to
            ...
            <div className="flex justify-end">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-fit px-8 py-3 bg-orange-500 text-black font-mono font-bold transition-all duration-300 rounded-none inline-block text-center cursor-pointer shadow-[0_0_15px_rgba(249,115,22,0.3)] hover:shadow-[0_0_25px_rgba(249,115,22,0.5)]"
                style={{
                  clipPath:
                    "polygon(10px 0, 100% 0, 100% calc(100% - 10px), calc(100% - 10px) 100%, 0 100%, 0 10px)",
                }}
              >
                <DecryptedText text="Explore the Hive" sequential speed={30} />
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="w-full mt-24 relative group cursor-pointer overflow-hidden border border-white/10 rounded-sm">
        ...
        <div className="relative aspect-21/9 w-full overflow-hidden">
          ...
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
            <p className="text-orange-500 font-mono text-sm tracking-[0.3em] uppercase mb-2 font-bold">
              The Team
            </p>
            <h3 className="text-white font-display text-2xl uppercase font-bold">
